...
public class detect_in_whole_image extends BRFBasicJavaExample {

	private Rectangle _faceDetectionRoi = new Rectangle();

	public detect_in_whole_image(Context context) {
		super(context);
	}
	...
	public void initCurrentExample(BRFManager brfManager, Rectangle resolution) {
		...
		Log.d("BRFv4", "BRFv4 - basic - face detection - detect faces in the whole image\n"+
